...
mySquadSocialNetwork.controller('NewsFeedController',
    ['$scope', 'postData', 'userData', 'commentData', 'credentials', 'toaster', 'defaultProfileImageData',
        function ($scope, postData, userData, commentData, credentials, toaster, defaultProfileImageData) {
        ...
        function postComment(commentContent, postId) {
            commentData.addComment(commentContent, postId)
                .$promise
                .then(function (data) {
                    toaster.pop('error', 'Success!', 'Comment added successfully.');
                    $scope.showNewCommentForm = false;
                    $scope.newCommentFormPostId = null;
                    getNewsFeed();
                }, function (error) {
