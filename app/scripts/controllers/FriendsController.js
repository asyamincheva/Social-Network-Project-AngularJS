...
mySquadSocialNetwork.controller('FriendsController',
    ['$scope', '$routeParams', '$location', '$timeout', 'credentials', 'userData', 'friendsData', 'toaster', 'defaultProfileImageData',
        function ($scope, $routeParams, $location, $timeout, credentials, userData, friendsData, toaster, defaultProfileImageData) {
