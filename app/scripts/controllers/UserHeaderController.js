...
mySquadSocialNetwork.controller('UserHeaderController',
    ['$scope', '$location', '$route', '$timeout', 'credentials', 'userData', 'friendsData', 'defaultProfileImageData', 'toaster',
        function ($scope, $location, $route, $timeout, credentials, userData, friendsData, defaultProfileImageData, toaster){
